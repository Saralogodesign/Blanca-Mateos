          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              <h3 className="font-serif text-2xl font-bold text-brand-accent">
                Hablemos sobre bilingüismo, programas de centro e internacionalización.
              </h3>
              <p className="text-brand-charcoal/70 text-base font-sans leading-relaxed">
                Disponible para consultas de mentoría, proyectos bilingües colaborativos de centro o intercambios educativos internacionales.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div className="overflow-hidden">
                  <p className="font-mono text-[10px] uppercase text-brand-charcoal/40 tracking-wider">Correo Electrónico Oficial</p>
                  <button 
                  ...
                  {copied && <span className="text-[10px] font-mono text-green-600 block mt-0.5">¡Copiado al portapapeles!</span>}
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  <p className="font-mono text-[10px] uppercase text-brand-charcoal/40 tracking-wider">Teléfono de Contacto</p>
                  <a href={`tel:${PERSONAL_INFO.contact.phone.replace(/\s+/g, "")}`} className="font-sans text-brand-charcoal font-semibold hover:text-brand-gold transition-colors block">
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  <p className="font-mono text-[10px] uppercase text-brand-charcoal/40 tracking-wider">Ubicación principal</p>
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  <p className="font-mono text-[10px] uppercase text-brand-charcoal/40 tracking-wider">Perfil Profesional</p>
                  <a 
          ...
          <div className="lg:col-span-7 bg-brand-beige p-8 md:p-10 rounded-2xl border border-brand-charcoal/5 shadow-sm relative">
            ...
            {submitted ? (
              <div className="bg-green-50 border border-green-200 text-green-800 p-6 rounded-xl flex items-start gap-4 animate-fade-in">
                ...
                <div>
                  <p className="font-semibold text-base mb-1">¡Mensaje enviado con éxito!</p>
                  <p className="text-sm text-green-700/90 leading-relaxed">
                    Gracias por ponerte en contacto. Blanca te responderá a la mayor brevedad posible al correo electrónico proporcionado.
                  </p>
                </div>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    <label className="font-mono text-[10px] uppercase text-brand-charcoal/50 block">Nombre Completo *</label>
                    <input
                      type="text"
                      required
                      value={name}
                  ...
                  {/* Email */}
                  <div className="space-y-1.5">
                    <label className="font-mono text-[10px] uppercase text-brand-charcoal/50 block">Correo Electrónico *</label>
                    <input
                      type="email"
                      required
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      placeholder="p. ej. tu@correo.com"
                      className="w-full bg-white border border-brand-charcoal/10 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-brand-accent focus:ring-1 focus:ring-brand-accent transition-all placeholder-brand-charcoal/35"
                    />
                  </div>
                </div>
                ...
                {/* Subject */}
                <div className="space-y-1.5">
                  <label className="font-mono text-[10px] uppercase text-brand-charcoal/50 block">Asunto de consulta</label>
                  <input
                    type="text"
                    value={subject}
                    onChange={(e) => setSubject(e.target.value)}
                    placeholder="p. ej. Propuesta de Intercambio / Colaboración"
                    className="w-full bg-white border border-brand-charcoal/10 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-brand-accent focus:ring-1 focus:ring-brand-accent transition-all placeholder-brand-charcoal/35"
                  />
                </div>
                ...
                {/* Message */}
                <div className="space-y-1.5">
                  <label className="font-mono text-[10px] uppercase text-brand-charcoal/50 block">Detalle de mensaje *</label>
                  <textarea
                    required
                    rows={5}
                    value={message}
